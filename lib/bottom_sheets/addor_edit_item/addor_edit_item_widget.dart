...
import 'addor_edit_item_model.dart';
export 'addor_edit_item_model.dart';
...
class AddorEditItemWidget extends StatefulWidget {
  ...
  final BillItemUIStruct? billItem;
  final bool? isEdit;

  @override
  State<AddorEditItemWidget> createState() => _AddorEditItemWidgetState();
}

class _AddorEditItemWidgetState extends State<AddorEditItemWidget> {
  late AddorEditItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddorEditItemModel());

    _model.itemNameTextController ??= TextEditingController(
        text: widget.isEdit! ? widget.billItem?.title : '');
    _model.itemNameFocusNode ??= FocusNode();

    _model.amountTextController ??= TextEditingController(
        text: widget.isEdit!
            ? formatNumber(
                widget.billItem?.amount,
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<UsersRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<UsersRecord> bottomSheetEditUsersRecordList = snapshot.data!;
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      multiSelectController: _model.dropDownValueController ??=
                        ...
                        (widget.isEdit!
                                ? widget.billItem?.participants
                                    .map((e) => e.id)
                                    .toList()
                                : bottomSheetEditUsersRecordList
                                    .take(1)
                                    .toList()
                                    .map((e) => e.uid)
                                    .toList()) ??
                      ...
                      options: List<String>.from(bottomSheetEditUsersRecordList
                          .map((e) => e.uid)
                          .toList()),
                      optionLabels: bottomSheetEditUsersRecordList
                          .map((e) => e.displayName)
                          .toList(),
                      height: 55.0,
                      searchHintTextStyle:
                  ...
                  Builder(
                    builder: (context) => Padding(
                      ...
                      child: FFButtonWidget(
                          ...
                          if ((_model.amountTextController.text != '') &&
                            ...
                            Navigator.pop(
                                ...
                                BillItemUIStruct(
                                  ...
                                  splitType: 'Enakovredno',
                                  participants: bottomSheetEditUsersRecordList
                                      .where((e) =>
                                          _model.dropDownValue!.contains(e.uid))
                                      .toList()
                                      .map((e) => e.reference)
                                      .toList(),
                                ));
                        ...
                        text: widget.isEdit! ? 'Uredi' : 'Dodaj',
