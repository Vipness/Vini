...
import 'join_household_model.dart';
export 'join_household_model.dart';

class JoinHouseholdWidget extends StatefulWidget {
  const JoinHouseholdWidget({super.key});

  @override
  State<JoinHouseholdWidget> createState() => _JoinHouseholdWidgetState();
}

class _JoinHouseholdWidgetState extends State<JoinHouseholdWidget> {
  late JoinHouseholdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JoinHouseholdModel());

    _model.userNameTextController ??=
        TextEditingController(text: currentUserDisplayName);
    _model.userNameFocusNode ??= FocusNode();

    _model.householdCodeTextController ??= TextEditingController();
    _model.householdCodeFocusNode ??= FocusNode();
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                width: double.infinity,
                child: TextFormField(
                  controller: _model.householdCodeTextController,
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator: _model.householdCodeTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
            Text(
              'Kodo lahko dobite od skrbnika skupine',
