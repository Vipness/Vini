            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  validator: _model.passwordConfTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if (_model.passwordTextController.text ==
                        _model.passwordConfTextController.text) {
