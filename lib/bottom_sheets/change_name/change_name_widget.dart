...
class _ChangeNameWidgetState extends State<ChangeNameWidget> {
  ...
  void initState() {
    ...
    _model.nameConfTextController ??= TextEditingController();
    _model.nameConfFocusNode ??= FocusNode();
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                width: double.infinity,
                child: TextFormField(
                  controller: _model.nameConfTextController,
                  focusNode: _model.nameConfFocusNode,
                  autofocus: false,
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'Ponovitev novega imena',
                    labelStyle:
                        FlutterFlowTheme.of(context).labelMedium.override(
                              font: GoogleFonts.inter(
                                fontWeight: FlutterFlowTheme.of(context)
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primary,
                  enableInteractiveSelection: true,
                  validator: _model.nameConfTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
                  ...
                  onPressed: () async {
                    if (_model.nameTextController.text ==
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Ime je bilo uspešno spremenjeno.',
                            style:
